...
def build_detailed_news_prompt(jobs: list[dict]) -> str:
    ...
    source_handling_lines = [
        ...
        "- Si si hay paginas internas pero una pagina esta borrosa, ilegible o insuficiente para reconstruir bien una historia, busca esa historia en la web y completala sin omitirla.",
        "- Trata las paginas borrosas o poco legibles como una senal de `web fallback` para esa historia puntual, no como motivo para devolver menos historias.",
    ...
    lines = [
        ...
        *source_handling_lines,
        ...
        "- Si una pagina no se lee bien, primero intenta resolver esa historia con busqueda web; luego dilo brevemente en `safety_notes` y redacta solo con lo confiable.",
        ...
        "- Si una pagina adjunta esta borrosa, cortada o no deja leer suficiente, busca esa misma historia en la web y usala como apoyo para completar el speech.",
        ...
        "- Si una historia tiene poco contexto legible, igual devuelvela; completa con web si hace falta, resume solo lo verificable y explica la limitacion en `safety_notes`.",
        "- Antes de cerrar, verifica que cada `headline_hint` del contexto previo tenga una historia correspondiente en la salida.",
        "- Antes de cerrar, cuenta cuantas historias vienen en `stories_detected_from_cover` para cada periodico y confirma que devuelves exactamente esa misma cantidad en `stories`, aunque hayas necesitado web por paginas borrosas.",
